...
# SaraONeal,5.17.2021,Created started script
# SaraONeal,5.17.2021,Added code to complete assignment 6
# SaraONeal,5.17.2021,Modified code to complete assignment 6
# SaraONeal,5.18.2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        for row in list_of_rows:
            if str(["Task"]).lower() == strTask.lower():
...
while (True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        print(task)
        Processor.remove_data_from_list(list_of_rows, task)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
